...
def ular(x_body):
    ...
    glBegin(GL_LINES)
    glColor3ub(0,0,0)
    glVertex2f(45+x_body,y_body+3)
    glVertex2f(45+x_body,y_body-4)
    glEnd()
    glPopMatrix()
...
def showScreen():
    ...
    if mulai == False:
        bg()
        drawText("P L A Y G A M E", 280,300,0,0,0)
        drawText("Press Enter to Play", 260,270,0,0,0)
